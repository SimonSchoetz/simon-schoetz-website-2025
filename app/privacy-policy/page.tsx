  ...
  return (
    <main className='flex flex-col gap-20 lg:gap-32 relative section-padding'>
      ...
      <Section>
        ...
        <H3
          text='Data recording on this website - Who is the responsible party for the recording of data on this website (i.e., the “controller”)?'
      ...
      <Section>
        ...
        <p className={pClassName}>
          Vercel Inc. 440 N Barranca Ave PMB 4133 Covina, CA, 91723-1722 USA
        </p>
        <p className={pClassName}>
          Find Vercel&apos;s privacy policy here:
          https://vercel.com/legal/privacy-policy.
        </p>
        <H3 text='Data processing' className={h3ClassName} />
        <p className={pClassName}>
      ...
      <Section>
        ...
        <H3 text='Storage duration' className={h3ClassName} />
        ...
        <H3 text='SSL and/or TLS encryption' className={h3ClassName} />
        <p className={pClassName}>
        ...
        <H3 text='Rejection of unsolicited e-mails' className={h3ClassName} />
        <p className={pClassName}>
      ...
      <Section>
        <H2 text='4. Recording of data on this website' />
        <H3
          text='Request by e-mail, telephone, or fax'
          className={h3ClassName}
        />
        <p className={pClassName}>
