import { Section, ExpandableChip, SectionHeader } from '@/components';
...
export const CareerPathsSection: FCProps<HtmlProps<'section'>> = ({
  ...
  return (
    <Section
      {...props}
      id='career-paths'
      className={`flex flex-col gap-10 section-padding ${className}`}
    >
      <SectionHeader
        heading='Career Paths'
        subheading='A Career Built in Layers'
      />
...
const careerPaths: {
    ...
    expandableContent: (
      <>
        <p>
          ...
          this secondary part of the game, where one could unlock additional
          content, as I had with the actual 3D action shooter that sold me the
          game in the first place. Growing up in the Bavarian outback, I had no
          other contact with coding beyond that. It wasn&apos;t until 15 years
          later that I picked it up again after seeing a commercial for the DCI
          Web Development program in a Berlin subway in 2019.
        </p>
        ...
        <p>
          ...
          deepen my skills and witness a young company evolving quickly. Here, I
          honed my technical abilities and increasingly specialized in frontend
    ...
    expandableContent: (
      <>
        ...
        <p>
          ...
          in the car industry and pursue my true passion, music production,
          after seeing a commercial for Deutsche POP in a Munich subway. (The
          careful reader might see a pattern here 😉.) It wasn&apos;t a
        ...
        <p>
          ...
          two and a half years turned my life upside down. Beyond learning the
          technical side of audio production, I developed skills that deeply
          shaped who I am today. The most important ones were learning how to
          give and receive sensitive, constructive feedback and how to navigate
          conflicting expectations in a collaborative process. Every musician
          pours their heart into their performance and wants to be heard above
          the rest. Every commercial client wants the loudest soundtrack to cut
          through the noise of competing ads, even when it compromises quality.
          A sound engineer&apos;s work is not only about achieving sonic balance
          within the physical constraints of a digitally or analog-mapped sound
          wave. It&apos;s a social process where empathy and clear
          decision-making are just as important as technical precision.
        </p>

        <p>
          The final year of my studies focused heavily on scientific research.
          It was a self-driven process, guided only by high-level expectations
          from the University of West London. That year taught me how to hold
          myself accountable and work independently—a skill I&apos;ve carried
        ...
        <p>
          ...
          way. My heart beats for the underground, where there&apos;s no money
          to be made, and I want to keep it that way. I had a good run as a
          music producer before the pandemic hit, and now, my only ambition is
          to keep the passion alive and have fun with it.
        </p>
      </>
    ),
  },
  {
    title: 'Car Industry',
    subTitle: 'A chapter closed, foundations built',
    expandableContent: (
      <>
        <p>
          ...
          through and finished my training. I didn&apos;t know what I wanted,
          but I knew I wanted more and needed to aim higher.
        </p>
        ...
        <p>
          ...
          theoretical exam focused on outdated technology. This path wasn&apos;t
          for me long-term. I wanted more than standing in a workshop and
          repairing cars. I wanted to grow, expand, and move beyond the limits I
          had been working within. So I left my rural hometown and moved to
          Munich.
        </p>
        ...
        <p>
          Despite the progress, I still didn&apos;t feel like I truly belonged.
          The male-dominated culture and lack of long-term recognition made me
